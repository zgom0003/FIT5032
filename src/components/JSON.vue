  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- TODO: CODE TO RENDER LIST OF AUSTEN'S WORKS HERE -->
       <ul>
        <li v-for="work in austen.famousWorks" :key="title">
    ...
    <section class="lab-section">
      ...
      <!-- TODO: CODE TO RENDER LIST OF STORE TYPES HERE -->
       <ul>
        <li v-for="(storeCount, storeType) in bookstores.storeTypes" :key="storeType">
      ...
      <!-- TODO: CODE TO RENDER LIST OF OPENING HOURS HERE -->
       <ul>
        <li v-for="(hours, days) in bookstores.openingHours" :key="days">
...
const highlight = (author) => {
  return author.name == 'George Orwell' ? {backgroundColor : 'yellow', color: 'black' } : {};
}
